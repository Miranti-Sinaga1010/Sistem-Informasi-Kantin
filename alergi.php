      ...
      <div id="content">
        ...
        <!-- Begin Page Content -->
          ...
          <hr>
                    ...
                    <a href="add_alergi.php" style="margin-left: 20px"><button style="background-color: #60A0B2">request alergi menu</button></a>
                    <br>
                    <br>

                  <div style="margin-left: 20px">
                    <table   style=" margin: 10px " border="1" >
                     <th>Status Request</th><th>Nama Menu</th> <th>Nama Mahasiswa</th><th>Tempat Makan</th>  <th>Kartu Alergi</th>
         <th>Perbaharui</th>
          <?php
            ...
            <table>
              <thead>
                <tr class="row100 head">
                  <th class="cell100 column1">Status Permintaan</th>
                  <th class="cell100 column2">Nama Menu</th>
                  <th class="cell100 column3">Nama Mahasiswa</th>
                  <th class="cell100 column4">Tempat Makan</th>
                  <th class="cell100 column3">Kartu Alergi</th>
                  <th class="cell100 column4">Pengaturan</th>
            ...
            <table>
              <tbody>
                <tr class="row100 body">
                  <?php
$sql = $pdo->prepare("SELECT * FROM alergimenu");
  $sql->execute();
   ...
   while($data = $sql->fetch()){
    ...
    echo "<td>".$data['tempatmakan']."</td>";
    echo "<td><img src='images/".$data['alergicard']."' width='100' height='100'></td>";
     echo "<td><a href='edit_alergi.php?id=$data[id]'>Ubah</a> | <a href='delete_alergi.php?id=$data[id]'>Hapus</a></td></tr>";
    echo "</tr>";
...
<hr>
<br>
<li  style="margin-left: 20px">kartu Alergi Didapat Dari Keasramaan</li>
