...
<body id="page-top">
  ...
  <hr class="sidebar-divider">
    ...
    <tr>
        <th>Status</th> <th>Nama Manu</th>Nama Mahasiswa<th></th>  <th>Tempat Makan</th> <th>Kartu Alergi</th>
         <th>Tanggapan</th>
...
$result = mysqli_query($mysqli, "SELECT * FROM alergimenu ORDER BY id ASC");
?>
    <?php  
    while($data = mysqli_fetch_array($result)) {         
        ...
        echo "<td><a href='tanggapan.php?id=$data[id]'>Berikan Tanggapan</a> </td></tr>";  
        echo "</tr>";
