...
$result = mysqli_query($mysqli, "SELECT * FROM bahan ORDER BY id DESC");
?>
<?php
  session_start();
?>
...
<body id="page-top">
 ...
 <div class="container-fluid">
          ...
          <div class="row">
            ...
            <button style="margin-left: 30px;"><a href="add_bahan.php"> Tambah Stock Bahan </a> </button><br>
        </div>
       <br>
        <div>
    ...
    <tr>
        <th>Tanggal di update</th> <th>Nama Bahan</th> <th>Jumlah Bahan</th><th>Harga Bahan</th> <th>Perbaharui</th>
    </tr>
    ...
    while($data = mysqli_fetch_array($result)) {         
        ...
        echo "<td><a href='edit_bahan.php?id=$data[id]'>Ubah</a> | <a href='delete_bahan.php?id=$data[id]'>Hapus</a></td></tr>";        
    }
    ?>
    </table>
</div>
