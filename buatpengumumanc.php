...
<body id="page-top">
  ...
  <hr class="sidebar-divider">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Content Row -->
          <form action="buatpengumumanc.php" method="post" name="Pengumuman">
              <div class="row">
            ...
            <div class="col-xl-1"></div>
            <div class="col-xl-1"><input type="submit" name="Submit" value="Tambah" style="background-color: #60A0B2; color: white;"></div>
    ...
    if(isset($_POST['Submit'])) {
        ...
        echo "Pengumuman telah ditambahkan. <a href='pengumumanc.php'>Lihat Pengumuman</a>";
    }
    ?>
