...
$result = mysqli_query($mysqli, "SELECT * FROM pengumuman WHERE id=$id");
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
         <div><i class="fas fa-bullhorn"> Detail Pengumuman</i></div>
          ...
          <!-- Content Row -->
           ...
           <form action="buatpengumumanc.php" method="post" name="Pengumuman">
            ...
            <div class="col-xl-8 mb-4"><?php echo $tanggal;?></div>  
        

            <div class="col-xl-3 mb-4">Judul Pengumuman</div>
            <div class="col-xl-1">:</div>
            <div class="col-xl-8 mb-4"><?php echo $judul;?></div>



            <div class="col-xl-3 mb-4">Isi Pengumuman</div>
            <div class="col-xl-1">:</div>
            <div class="col-xl-8 mb-4"><?php echo $isi;?></div>

            <div class="col-xl-3 mb-4">Pengirim</div>
            <div class="col-xl-1">:</div>
            <div class="col-xl-8 mb-4"><?php echo $pengirim;?></div>
