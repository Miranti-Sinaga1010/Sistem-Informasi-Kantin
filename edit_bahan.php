...
{   
    ...
    // update user data
    $result = mysqli_query($mysqli, "UPDATE bahan SET tanggal='$tanggal',nama='$nama',jumlah='$harga' WHERE id=$id");
...
$result = mysqli_query($mysqli, "SELECT * FROM bahan WHERE id=$id");
...
<body id="page-top">
  ...
  <hr class="sidebar-divider">
    ...
    <form name="update_bahan" method="post" action="edit_bahan.php">
        
              <div class="row">
            
            <div class="col-xl-3 mb-4">Tanggal Penambahan Stock</div>
            <div class="col-xl-1"></div>
            <div class="col-xl-8 mb-4"><input type="date" name="tanggal" style="width: 500px"; value=<?php echo $tanggal;?>></div>  
        

            <div class="col-xl-3 mb-4">Nama Bahan</div>
            <div class="col-xl-1"></div>
            <div class="col-xl-8 mb-4"><input type="text" name="nama" style="width: 500px;"value=<?php echo $nama;?>></div>



            <div class="col-xl-3 mb-4">Jumlah Bahan</div>
            <div class="col-xl-1"></div>
            <div class="col-xl-8 mb-4"><input type="text" name="jumlah" style="width: 500px;"value=<?php echo $jumlah;?>></div>

            <div class="col-xl-3 mb-4">Harga</div>
            <div class="col-xl-1"></div>
            <div class="col-xl-8 mb-4"><input type="text" name="harga" style="width : 500px;" value=<?php echo $harga;?>></div>

            <div class="col-xl-10"></div>
            <div class="col-xl-1"><input type="hidden" name="id" value=<?php echo $_GET['id'];?>> </div>
            <div class="col-xl-1"><input style="background-color: #60A0B2; color: white;" type="submit" name="update" value="Ubah"></div>
