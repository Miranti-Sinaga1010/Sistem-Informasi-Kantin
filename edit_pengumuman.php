...
{   
    ...
    // update user data
    $result = mysqli_query($mysqli, "UPDATE pengumuman SET tanggal='$tanggal',judul='$judul',isi='$isi',pengirim='$pengirim'  WHERE id=$id");

    // Redirect to homepage to display updated user in list
    header("Location: pengumumanc.php");
}
?>
<?php
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Content Row -->
          <form action="edit_pengumuman.php" method="post" name="edit">
            <table border="0">
            <tr> 
                <td>Tanggal</td>
           ...
           <tr> 
            ...
            <tr>
                ...
                <td><input style="background: #60A0B2" type="submit" name="update" value="Ubah" ></td>
            </tr>
