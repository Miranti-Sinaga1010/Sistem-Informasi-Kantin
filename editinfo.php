          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Chef</span>
        ...
        <!-- Begin Page Content -->
         ...
         <div><i class="fas fa-flask"> Informasi Makanan</i></div>
          ...
          <!-- Content Row -->
            ...
            <div class="col-xl-3 mb-4">Nama Makanan</div>
            <div class="col-xl-1"></div>
            <div class="col-xl-8 mb-4"><input type="text" name="Judul" style="width: 500px;"></div>



            <div class="col-xl-3 mb-4">Deskrpsi Makanan</div>
            <div class="col-xl-1"></div>
            ...
            <div class="col-xl-1"></div>
            <div class="col-xl-8 mb-4"><input type="file" name="image" style="width : 500px;"></div>

            <div class="col-xl-10"></div>
            <div class="col-xl-1"></div>
            <div class="col-xl-1"><a href="informasic.php"><button style="background-color: #60A0B2; color: white;">Simpan</button></a></div>
