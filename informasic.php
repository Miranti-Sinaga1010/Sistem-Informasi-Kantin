      ...
      <div id="content">
        ...
        <!-- Begin Page Content -->
         <div class="container-fluid">
          ...
          <!-- Page Heading -->
         <div><i class="fas fa-flask"> Jadwal Makan</i></div>
          ...
          <div class="row">
            <style type="text/css">
             ...
             <div class="col-xl-12"><a href="tambahmenu.php"><button><i class="fas fa-plus"></i> Tambah Jadwal Makan untuk kantin baru</button></a></div><br><br>

             <div class="col-xl-12"><a href="tambahmenux.php"><button><i class="fas fa-plus"></i> Tambah Jadwal Makan untuk kantin lama</button></a></div><br><br>
