...
$result = mysqli_query($mysqli, "SELECT * FROM jlhmhs ORDER BY id DESC");
?>
        <!-- Begin Page Content -->
      <a href="updatea.php" style="margin-left: 20px">Tambah daftar jumlah mahasiswa yang akan makan</a><br/><br/>

    <table width='80%' border=1 style="margin-left: 20px">

    <tr>
        <th>Tanggal</th> <th>Waktu</th><th>Kantin</th>  <th>Jumlah Mahasiswa</th>
         <th>Perbaharui</th>
    </tr>
    <?php  
    while($jlhmhs_data = mysqli_fetch_array($result)) {         
        echo "<tr>";
        echo "<td>".$jlhmhs_data['tanggal']."</td>";
        echo "<td>".$jlhmhs_data['waktu']."</td>";
        echo "<td>".$jlhmhs_data['kb']."</td>";
        echo "<td>".$jlhmhs_data['kl']."</td>";
            
        echo "<td><a href='edit.php?id=$jlhmhs_data[id]'>Ubah</a> | <a href='delete_jlhmhs.php?id=$jlhmhs_data[id]'>Hapus</a></td></tr>";        
    }
    ?>
    </table>
