      ...
      <div id="content">
        ...
        <!-- Begin Page Content -->
         <div class="container-fluid">
          ...
          <!-- Page Heading -->
         <div><i class="fas fa-comments"> Kritik/Saran</i></div>
         ...
         <div class="row">
            ...
            <div class="col-xl-5">
              Kritik
              <div>[NEW] Piket kantin pada hari kamis akan</div><br>
              <div>Semoga desain cepat selesai</div><br>
              <div>Desain lama</div>
            </div>
            ...
            <div class="col-xl-5">
              Saran
              <div>Desain di percepat yah</div><br>
              <div>Jangan lambat</div><br>
              <div>Submitan bentar lagi</div><br>
              <div>OMG !</div>
            </div>
