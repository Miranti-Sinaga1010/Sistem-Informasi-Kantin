...
<?php
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
         <div><i class="fas fa-pen"> Request Alergi Makanan</i></div>
          ...
          <div class="row">
            ...
            <div class="col-xl-8 mb-4"><input type="text" name="date" style="width: 600px";></div>  
        

            <div class="col-xl-3 mb-4">Lokasi Makan</div>
            <div class="col-xl-1"></div>
            <div class="col-xl-8 mb-4"><input type="text" name="Judul" style="width: 600px;"></div>

            <div class="col-xl-3 mb-4">Alergi Makanan</div>
            <div class="col-xl-1"></div>
            <div class="col-xl-8 mb-4"><input type="text" name="date" style="width : 600px; height: 300px;"></div>
