...
$result = mysqli_query($mysqli, "SELECT * FROM keranjang where konfirmasi_pengantaran = 'selesai diantar'");
?>
...
<br>
    ...
    echo "<tr>";
        ...
        echo "<td><a href='selesai_diantar.php?id=$user_data[id_pemesanan]'>selesai diantar</a> || <a href='delete.php?id=$user_data[id_pemesanan]'>tolak</a></td>";
    echo "</tr>";
