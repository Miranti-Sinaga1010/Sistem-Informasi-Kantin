...
$result = mysqli_query($mysqli, "SELECT * FROM keranjang where konfirmasi = 'selesai dimasak'");
?>
...
<br>
<a href="index_chef.php">Home</a><br>
<a href="menu_chef.php">Tampilkan semua menu</a><br>
<a href="daftar_yang_akan_dimasak.php">yang akan dimasak</a><br>
<a href="add.php">Add New Menu</a><br/><br/>
    ...
    echo "<tr>";
        ...
        echo "<td><a href='terima.php?id=$user_data[id_pemesanan]'>kirim</a> || <a href='delete.php?id=$user_data[id_pemesanan]'>tolak</a></td>";
    echo "</tr>";
