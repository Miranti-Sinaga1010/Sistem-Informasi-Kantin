  ...
  <hr class="sidebar-divider">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Begin Page Content -->
      <form action="Updatea.php" method="post" name="form1">
         <div class="row" style="margin-left: 20px">
            ...
            <div class="col-xl-3 mb-4">Waktu</div>
            <div class="col-xl-1">:</div>
            <div class="col-xl-8 mb-4"><p><input type="radio" name="waktu" value="pagi">Pagi</p><p><input type="radio" name="waktu" value="siang">Siang</p><p><input type="radio" name="waktu" value="malam">Malam</p></div>

            <div class="col-xl-3 mb-4">Jumlah Makan di Kantin Baru </div>
            <div class="col-xl-1">:</div>
            <div class="col-xl-8 mb-4"><input type="text" name="kb" style="width: 500px;"></div>

             <div class="col-xl-3 mb-4">Jumlah Makan di Kantin Lama </div>
            <div class="col-xl-1">:</div>
            <div class="col-xl-8 mb-4"><input type="text" name="kl" style="width: 500px;"></div>
    ...
    if(isset($_POST['Submit'])) {
        ...
        $result = mysqli_query($mysqli, "INSERT INTO jlhmhs(tanggal,waktu,kb,kl) VALUES('$tanggal','$waktu','$kb','$kl')");

        // Show message when user added
        echo "jumlah mahasiswa yang akan makan berhasil di tambahkan. <a href='jumlahmahasiswa.php'>Lihat daftar nya</a>";
    }
    ?>
