...
<body id="page-top">
  ...
  <hr class="sidebar-divider">
    ...
    <tr>
        <th>Tanggal</th> <th>Waktu</th><th>Kantin Baru</th>  <th>Kantin Lama</th>
...
$result = mysqli_query($mysqli, "SELECT * FROM jlhmhs ORDER BY id ASC");
?>
    <?php  
    while($jlhmhs_data = mysqli_fetch_array($result)) {         
        ...
        // echo "<td><a href='edit.php?id=$jlhmhs_data[id]'>Ubah</a> | <a href='delete.php?id=$jlhmhs_data[id]'>Hapus</a></td></tr>";        
    }
    ?>
    </table>
